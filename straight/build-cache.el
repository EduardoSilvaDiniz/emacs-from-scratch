...
#s(hash-table test equal data ("straight" ("2024-10-22 13:40:10" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2024-10-22 13:40:10" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2024-10-22 13:40:10" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2024-10-22 13:40:10" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2024-10-22 13:40:10" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2024-10-22 13:40:10" nil (:type git :host github :repo "dimitri/el-get" :build nil :files (:defaults "methods" ("recipes" "recipes/el-get.rcp") "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2024-10-22 13:40:10" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "lspce" ("2024-10-22 13:40:10" nil (:type git :host github :repo "zbelial/lspce" :files (:defaults "lspce-module.so") :pre-build (("cargo" "build" "--release") ("cp" "./target/release/liblspce_module.so" "./lspce-module.so")) :package "lspce" :local-repo "lspce")) "el-patch" ("2024-10-22 13:40:10" nil (:type git :host github :repo "jdtsmith/eglot-booster" :flavor melpa :package "el-patch" :local-repo "eglot-booster"))))
...
(fn &optional PACKAGE)" t) (register-definition-prefixes "straight" '("straight-")) (register-definition-prefixes "straight-ert-print-hack" '("+without-print-limits")) (defvar straight-x-pinned-packages nil "List of pinned packages.") (register-definition-prefixes "straight-x" '("straight-x-")) (provide 'straight-autoloads)) "lspce" ((lspce-autoloads lspce lspce-util lspce-types lspce-structs lspce-snippet lspce-langs lspce-calltree) (defvar-local lspce-workspace-configuration nil "Configure LSP servers specifically for a given project.") (put 'lspce-workspace-configuration 'safe-local-variable 'listp) (autoload 'lspce-enable-notification-handler "lspce" nil t) (autoload 'lspce-disable-notification-handler "lspce" nil t) (autoload 'lspce-mode "lspce" "Mode for source buffers managed by some LSPCE project.
...
(fn &optional ARG)" t) (autoload 'xref-find-implementations "lspce" "Find implementations to the identifier at point.
...
(fn IDENTIFIER)" t) (autoload 'xref-find-type-definition "lspce" "Find type definition to the IDENTIFIER at point.
This command might prompt for the identifier as needed, perhaps
offering the symbol at point as the default.
With prefix argument, or if `xref-prompt-for-identifier' is t,
always prompt for the identifier.  If `xref-prompt-for-identifier'
...
(fn IDENTIFIER)" t) (autoload 'xref-find-declaration "lspce" "Find declaration to the IDENTIFIER at point.
This command might prompt for the identifier as needed, perhaps
offering the symbol at point as the default.
With prefix argument, or if `xref-prompt-for-identifier' is t,
always prompt for the identifier.  If `xref-prompt-for-identifier'
...
(fn IDENTIFIER)" t) (autoload 'lspce-jdtls-update-project-configuration "lspce" "Updates the Java configuration, refreshing settings from build artifacts" t) (autoload 'lspce-jdtls-reset-project "lspce" "Updates the Java configuration, refreshing settings from build artifacts" t) (register-definition-prefixes "lspce" '("lspce-")) (autoload 'lspce-incoming-calls-to-ivy "lspce-calltree" "Fetch incoming calls to current symbol, render the result with ivy." t) (autoload 'lspce-incoming-calls-to-org "lspce-calltree" "Fetch incoming calls to current symbol, render the result in orgmode format." t) (register-definition-prefixes "lspce-calltree" '("lspce--")) (defvar lspce-java-path "java" "Path of the java executable.") (custom-autoload 'lspce-java-path "lspce-langs" t) (autoload 'lspce-install-jdtls-server "lspce-langs" "Install the Eclipse JDT LSP server." t) (register-definition-prefixes "lspce-langs" '("lspce-")) (register-definition-prefixes "lspce-snippet" '("lspce--expand-snippet")) (register-definition-prefixes "lspce-types" '("LSPCE-" "lspce--")) (register-definition-prefixes "lspce-util" '("LSPCE-" "lspce-")) (provide 'lspce-autoloads)) "el-patch" ((el-patch-autoloads eglot-booster) (defvar eglot-booster-mode nil "Non-nil if Eglot-Booster mode is enabled.
...
(fn &optional ARG)" t) (register-definition-prefixes "eglot-booster" '("eglot-booster-")) (provide 'el-patch-autoloads))))

#s(hash-table test eq data (org-elpa #s(hash-table test equal data (version 15 "melpa" nil "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "lspce" nil "eglot-booster" nil "el-patch" nil)) melpa #s(hash-table test equal data (version 2 "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" (el-get :type git :flavor melpa :files (:defaults "methods" ("recipes" "recipes/el-get.rcp") "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "lspce" nil "eglot-booster" nil "el-patch" (el-patch :type git :flavor melpa :host github :repo "radian-software/el-patch"))) gnu-elpa-mirror #s(hash-table test equal data (version 3 "nongnu-elpa" nil "emacsmirror-mirror" nil "straight" nil "lspce" nil "eglot-booster" nil)) nongnu-elpa #s(hash-table test equal data (version 4 "emacsmirror-mirror" nil "straight" nil "lspce" nil "eglot-booster" nil)) el-get #s(hash-table test equal data (version 2 "emacsmirror-mirror" nil "straight" nil "lspce" nil "eglot-booster" nil)) emacsmirror-mirror #s(hash-table test equal data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "lspce" nil "eglot-booster" nil))))

("el-patch" "lspce" "emacs" "straight" "emacsmirror-mirror" "el-get" "nongnu-elpa" "gnu-elpa-mirror" "melpa" "org-elpa")
